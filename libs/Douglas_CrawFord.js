...
Function.method('inherits', function(parent) {
    ...
    this.method('uber', function uber(name) {
        ...
        if (depth) {
            ...
            if (func === this[name]) { // Go to the parent's prototype instead
                func = v[name];
            }
        }
        ...
        depth += 1;
        // Call the function to execute with all the arguments but the first // (which holds the name of the function that we're executing)
...
console.log(new User("patrick","898979").getPassword())